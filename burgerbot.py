...
ua_url = 'https://service.berlin.de/terminvereinbarung/termin/tag.php?termin=1&dienstleister=330857&anliegen[' \
         ']=330869&herkunft=1 '
...
""")
    ...
    def __start(self, update: Update, _: CallbackContext) -> None:
        ...
        update.message.reply_text(
            'Welcome to BurgerBot. When there will be slot - you will receive notification. To get information about '
            'usage - type /help. To stop it - just type /stop')
    ...
    def __send_message(self, slot: Slot) -> None:
        ...
        md_msg = f"There are slots on {self.__date_from_msg(slot.msg)} available for booking " \
                 f"for {service_map[slot.service_id]}, click [here]({build_url(slot.service_id)}) to check it out "
